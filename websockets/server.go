...
func (s *Server) handleMoveMessage(_ *Connection, content interface{}) {
	...
	firebasedb.FirebaseClient.ReadGameBoard("games", "bot", &game)

	gameInfo := map[string]interface{}{}
	firebasedb.FirebaseClient.ReadGame("games", "bot", &gameInfo)
	...
	firebasedb.FirebaseClient.ReadGameMoves("games", "bot", &moves)
	...
	firebasedb.FirebaseClient.UpdateGame("bot", update)
